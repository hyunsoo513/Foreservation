                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        <div class="nav-item dropdown">
                            <a href="GnrSrch.action" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">온라인예약</a>
                            <div class="dropdown-menu bg-light mt-2">
                                <a href="GnrSrch.action" class="dropdown-item">일반/숙박예약</a>
                                <a href="PrgmSrch.action" class="dropdown-item">프로그램예약</a>
                                <a href="MonthSrch.action" class="dropdown-item active">월별예약조회</a>
                            </div>
                        </div>
